  ...
  function skillCatalog(projectId) {
    ...
    return [...ids].map((id) => {
      ...
      return {
        ...
        maturity: installation?.maturity || shipped?.maturity || base.maturity || (base.status === 'planned' ? 'planned' : 'beta'),
        installation,
        bundled: shipped,
        remoteSkill,
        latestVersion,
  ...
  function projectSelectableSkillCatalog(remoteSkills = [], projectId = null) {
    ...
    for (const remote of list(remoteSkills)) {
      ...
      items.set(id, {
        ...
        maturity: installation?.maturity || remote.maturity || 'experimental',
        installation,
        remoteSkill: remote,
        capabilityType: 'skill',
      });
  ...
  function connectorCatalog() {
    ...
    return [...ids].map((id) => {
      ...
      return {
        ...
        maturity: binding?.maturity || base.maturity || (base.status === 'planned' ? 'planned' : binding ? 'experimental' : 'beta'),
        binding,
