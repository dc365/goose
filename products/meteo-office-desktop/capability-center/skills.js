(function capabilityCenterSkills(root) {
  ...
  function inspect(inspection) {
    ...
    const existingInstallation = api.skillInstallation(report.skill.id);
          ...
          try {
            ...
            if (inspection.remote) {
              void root.meteoDesktop.reportSkillHubInstallation({
                localInstallationId: result.installation.id,
                remoteInstallationId: result.installation.remote?.skillHubInstallationId,
