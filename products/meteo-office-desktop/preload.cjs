...
contextBridge.exposeInMainWorld('meteoDesktop', {
  ...
  listSharedProjects: (request) => ipcRenderer.invoke('shared-project:list', request),
  getSharedProject: (id) => ipcRenderer.invoke('shared-project:get', id),
  publishSharedProject: (request) => ipcRenderer.invoke('shared-project:publish', request),
  ...
  getMemoryState: () => ipcRenderer.invoke('memory:state'),
  listMemories: (request) => ipcRenderer.invoke('memory:list', request),
  getMemory: (request) => ipcRenderer.invoke('memory:get', request),
  createMemory: (request) => ipcRenderer.invoke('memory:create', request),
  updateMemory: (request) => ipcRenderer.invoke('memory:update', request),
  setMemoryStatus: (request) => ipcRenderer.invoke('memory:set-status', request),
  deleteMemory: (request) => ipcRenderer.invoke('memory:delete', request),
  retrieveMemories: (request) => ipcRenderer.invoke('memory:retrieve', request),
  markMemoriesUsed: (request) => ipcRenderer.invoke('memory:mark-used', request),
  getMemoryHistory: (request) => ipcRenderer.invoke('memory:history', request),
  getMemoryStats: (request) => ipcRenderer.invoke('memory:stats', request),
  setMemoryEnabled: (enabled) => ipcRenderer.invoke('memory:set-enabled', { enabled }),
